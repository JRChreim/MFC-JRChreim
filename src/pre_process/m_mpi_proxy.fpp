...
contains
    ...
    impure subroutine s_mpi_bcast_user_inputs
        ...
        #:for VAR in ['stretch_type', 't_step_old', 't_step_start', 'm', 'n', 'p', 'm_glb', 'n_glb', 'p_glb', &
        ...
        #:for VAR in [ 'old_grid','old_ic','stretch_x','stretch_y','stretch_z',&
            ...
            & 'igr', 'down_sample', 'simplex_perturb','fft_wrt', 'sph_coord']
        ...
        #:for VAR in [ 'x_domain%beg', 'x_domain%end', 'y_domain%beg',         &
            ...
            & 'mixlayer_perturb_k0', 'oneway_vf', 'under_relax']
